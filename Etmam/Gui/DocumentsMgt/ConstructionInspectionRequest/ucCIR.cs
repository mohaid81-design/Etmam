...
namespace Etmam
{
    public partial class ucCIR : BaseUserControl
    {
        ...
        private void SetupAconexStyle()
        {
            ...
            SetCaption("Description",    "وصف العمل المطلوب فحصه");
            ...
            SetCaption("PreparedDate",   "تاريخ طلب الفحص");
        ...
        public void LoadData()
        {
            ...
            var data = DC.DrawingsSubmittalList.GetBy("PrjId = @PrjId AND IsDelete = 0 AND Type = @Type", new { PrjId = prjId, Type = "CIR" });
            DataSource.Clear();
        ...
        {
            ///*var*/ frm    = new frmSubmittalAddEdit("CIR", id);
        ...
        private void bbiPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
            => PrintHelper.PrintCIR(DataSource);
    }
}
