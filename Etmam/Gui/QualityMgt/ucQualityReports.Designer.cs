...
{
    partial class ucQualityReports
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.splitContainerControlMain.Panel1.Text = "قائمة تقارير ومؤشرات الجودة QMS";
            ...
            this.lstReports.Items.AddRange(new object[] {
                "سجل وتقارير طلبات الفحص والموقعية (Inspection Report)",
                "تقرير حالات عدم المطابقة والتحليل الجذري (NCR Report)",
                "تقرير سجل نواقص التشطيبات (Punch List Report)",
                "تقرير الإجراءات التصحيحية والوقائية (CAPA Report)",
                "سجل فحوصات محضر التسليم والاستلام (Handover Report)",
                "تقرير مؤشرات أداء الجودة ومؤشر الأمان (Quality KPI Report)",
                "تقرير حسابات تكلفة إعادة العمل والخسائر (Rework Cost Report)"
            });
            ...
            this.lblSelectedReportTitle.Text = "سجل وتقارير طلبات الفحص والموقعية الشامل";
