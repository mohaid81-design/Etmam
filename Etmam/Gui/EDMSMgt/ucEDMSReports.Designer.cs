namespace Etmam.Gui.EDMSMgt
{
    partial class ucEDMSReports
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.splitContainerControlMain.Panel1.Text = "قائمة تقارير نظام الوثائق EDMS";
            ...
            this.lstReports.Items.AddRange(new object[] {
                "سجل الوثائق والمستندات الشامل (Document Register)",
                "سجل الرسومات والمخططات الهندسية (Drawing Register)",
                "تقرير طلبات اعتماد المواد (MSR Report)",
                "تقرير طلبات الاستفسارات الفنية (RFI Report)",
                "تقرير خطابات التسليم والارسال (Transmittal Report)",
                "تقرير المراسلات الواردة والصادرة (Correspondence Report)",
                "تقرير حالات الاعتماد ومسار العمل (Workflow Report)",
                "سجل وتاريخ تعديل الإصدارات (Revision History)",
                "تقرير مصفوفة التوزيع والارسال (Distribution Report)"
            });
            ...
            this.lblSelectedReportTitle.Text = "تقرير سجل الوثائق والمستندات الشامل";
