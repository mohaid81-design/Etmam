namespace Etmam
{
    partial class frmPurchaseRequestSelect
    {
        ...
        private void InitializeComponent()
        {
            ...
            colFormattedNum = new DevExpress.XtraGrid.Columns.GridColumn();
            colRequestDate = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            gridView1.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] { colFormattedNum, colRequestDate, colPurpose });
            ...
            // colFormattedNum
            // 
            colFormattedNum.AppearanceCell.Options.UseTextOptions = true;
            colFormattedNum.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            colFormattedNum.Caption = "رقم الطلب";
            colFormattedNum.FieldName = "FormattedNum";
            colFormattedNum.MinWidth = 25;
            colFormattedNum.Name = "colFormattedNum";
            colFormattedNum.Visible = true;
            colFormattedNum.VisibleIndex = 0;
            colFormattedNum.Width = 130;
            // 
            // colRequestDate
            // 
            colRequestDate.AppearanceCell.Options.UseTextOptions = true;
            colRequestDate.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            colRequestDate.Caption = "تاريخ الطلب";
            colRequestDate.DisplayFormat.FormatString = "yyyy-MM-dd";
            colRequestDate.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            colRequestDate.FieldName = "RequestDate";
            colRequestDate.MinWidth = 25;
            colRequestDate.Name = "colRequestDate";
            colRequestDate.Visible = true;
            colRequestDate.VisibleIndex = 1;
            colRequestDate.Width = 110;
            // 
            // colPurpose
            // 
            colPurpose.Caption = "الغرض";
            colPurpose.FieldName = "Purpose";
            colPurpose.MinWidth = 25;
            colPurpose.Name = "colPurpose";
            colPurpose.Visible = true;
            colPurpose.VisibleIndex = 2;
            colPurpose.Width = 300;
            // 
            // frmPurchaseRequestSelect
            // 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colFormattedNum;
