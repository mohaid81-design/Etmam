namespace Etmam
{
    partial class ucSubcontractorMgt
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ucProjectMgt));
            ...
            tbInventory = new DevExpress.XtraBars.Navigation.TileBar();
            ...
            // tbInventory
            // 
            tbInventory.AppearanceItem.Disabled.BackColor = Color.FromArgb(50, 65, 90);
            tbInventory.AppearanceItem.Disabled.Font = new Font("Cairo", 8.5F);
            tbInventory.AppearanceItem.Disabled.ForeColor = Color.FromArgb(130, 145, 165);
            tbInventory.AppearanceItem.Disabled.Options.UseBackColor = true;
            tbInventory.AppearanceItem.Disabled.Options.UseFont = true;
            tbInventory.AppearanceItem.Disabled.Options.UseForeColor = true;
            tbInventory.AppearanceItem.Hovered.BackColor = Color.FromArgb(52, 100, 195);
            tbInventory.AppearanceItem.Hovered.BorderColor = Color.White;
            tbInventory.AppearanceItem.Hovered.Font = new Font("Cairo", 9F, FontStyle.Bold);
            tbInventory.AppearanceItem.Hovered.ForeColor = Color.FromArgb(100, 160, 255);
            tbInventory.AppearanceItem.Hovered.Options.UseBackColor = true;
            tbInventory.AppearanceItem.Hovered.Options.UseBorderColor = true;
            tbInventory.AppearanceItem.Hovered.Options.UseFont = true;
            tbInventory.AppearanceItem.Hovered.Options.UseForeColor = true;
            tbInventory.AppearanceItem.Normal.BackColor = Color.FromArgb(28, 62, 120);
            tbInventory.AppearanceItem.Normal.BorderColor = Color.FromArgb(45, 90, 160);
            tbInventory.AppearanceItem.Normal.Font = new Font("Cairo", 9F, FontStyle.Bold);
            tbInventory.AppearanceItem.Normal.ForeColor = Color.FromArgb(210, 228, 255);
            tbInventory.AppearanceItem.Normal.Options.UseBackColor = true;
            tbInventory.AppearanceItem.Normal.Options.UseBorderColor = true;
            tbInventory.AppearanceItem.Normal.Options.UseFont = true;
            tbInventory.AppearanceItem.Normal.Options.UseForeColor = true;
            tbInventory.AppearanceItem.Pressed.BackColor = Color.FromArgb(12, 45, 100);
            tbInventory.AppearanceItem.Pressed.BorderColor = Color.FromArgb(80, 140, 240);
            tbInventory.AppearanceItem.Pressed.Font = new Font("Cairo", 9F, FontStyle.Bold);
            tbInventory.AppearanceItem.Pressed.ForeColor = Color.White;
            tbInventory.AppearanceItem.Pressed.Options.UseBackColor = true;
            tbInventory.AppearanceItem.Pressed.Options.UseBorderColor = true;
            tbInventory.AppearanceItem.Pressed.Options.UseFont = true;
            tbInventory.AppearanceItem.Pressed.Options.UseForeColor = true;
            tbInventory.AppearanceItem.Selected.BackColor = Color.FromArgb(10, 70, 170);
            tbInventory.AppearanceItem.Selected.BorderColor = Color.FromArgb(70, 150, 255);
            tbInventory.AppearanceItem.Selected.Font = new Font("Cairo", 9F, FontStyle.Bold);
            tbInventory.AppearanceItem.Selected.ForeColor = Color.White;
            tbInventory.AppearanceItem.Selected.Options.UseBackColor = true;
            tbInventory.AppearanceItem.Selected.Options.UseBorderColor = true;
            tbInventory.AppearanceItem.Selected.Options.UseFont = true;
            tbInventory.AppearanceItem.Selected.Options.UseForeColor = true;
            tbInventory.BackColor = Color.FromArgb(215, 215, 215);
            tbInventory.Dock = DockStyle.Top;
            tbInventory.DropDownOptions.BeakColor = Color.Empty;
            tbInventory.Groups.Add(tbgInventory);
            tbInventory.ItemPadding = new Padding(16, 6, 16, 6);
            tbInventory.Location = new Point(0, 0);
            tbInventory.MaxId = 9;
            tbInventory.Name = "tbInventory";
            tbInventory.Padding = new Padding(16, 6, 16, 6);
            tbInventory.ScrollMode = DevExpress.XtraEditors.TileControlScrollMode.ScrollButtons;
            tbInventory.Size = new Size(1404, 100);
            tbInventory.TabIndex = 0;
            tbInventory.Text = "tileBar1";
            // 
            // tbgInventory
            // 
        ...
        private DevExpress.XtraBars.Navigation.TileBar tbInventory;
