namespace Etmam.Gui.HSEMgt
{
    partial class ucHSEReports
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.splitContainerControlMain.Panel1.Text = "قائمة تقارير ومؤشرات السلامة والبيئة HSE";
            ...
            this.lstReports.Items.AddRange(new object[] {
                "سجل وتقارير الحوادث والإصابات (Incident Report)",
                "تقرير الحوادث الوشيكة وإجراءات السلامة (Near Miss Report)",
                "تقرير تصاريح العمل وسجل الأنواع (PTW Report)",
                "تقرير تحليل وتحييد المخاطر (JSA/JHA Report)",
                "تقرير التدريب وتراخيص العمالة (Training Report)",
                "سجل عهد ومستلزمات الوقاية (PPE Report)",
                "تقرير جولات وجداول التفتيش (Inspection Report)",
                "تقرير الرصد ومعدلات التلوث (Environmental Report)",
                "تقرير مؤشرات أداء السلامة والأمان (HSE KPI Report - TRIR/LTIFR)"
            });
            ...
            this.lblSelectedReportTitle.Text = "تقرير مؤشرات أداء السلامة والأمان HSE KPI (TRIR / LTIFR)";
