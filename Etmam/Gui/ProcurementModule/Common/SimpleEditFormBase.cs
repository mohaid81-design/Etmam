...
namespace Etmam
{
    ...
    public abstract class SimpleEditFormBase<T> : XtraForm where T : class, IBaseEntity, new()
    {
        ...
        /// <summary>Called once, right after a brand-new record is inserted (not on edit of an existing one).</summary>
        protected virtual void OnAfterInsert(T entity) { }
        ...
        /// <summary>Shared overlay/spinner helpers (SplashScreenManager pattern).</summary>
