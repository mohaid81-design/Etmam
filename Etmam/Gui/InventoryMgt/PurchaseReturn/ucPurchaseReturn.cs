...
namespace Etmam
{
    ...
    {
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit riLookUpStore = null!;
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit riLookUpStakeholder = null!;
        ...
        private void InitializeGrid()
        {
            ...
            gridControl1.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] { riLookUpStore, riLookUpStakeholder });
            ...
            var colStore = gridView1.Columns.AddVisible("StoreId", "من مخزن");
            colStore.ColumnEdit = riLookUpStore;
            colStore.Width = 200;

            var colStakeholder = gridView1.Columns.AddVisible("StakeholderId", "المورد");
            colStakeholder.ColumnEdit = riLookUpStakeholder;
            colStakeholder.Width = 200;
        ...
        public void LoadData()
        {
            try
            {
                ...
                var data = dc.PurchaseReturnList.GetBy(filter, new { PrjId = prjId, StoreId = storeVal });
        ...
        {
            using (var frm = new frmPurchaseReturnAddEdit(id))
            {
